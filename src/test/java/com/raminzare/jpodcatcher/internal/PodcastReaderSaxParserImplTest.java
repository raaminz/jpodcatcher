...
class PodcastReaderSaxParserImplTest {
    ...
    void load_RSS_should_contain_channel_data(@RSSURI("simple_podcast.rss") String simplePodcastURI) throws PodcastReaderException {
        ...
        assertAll(() -> assertThat(channel.title() , is("Raw Data")),
                () -> assertThat(channel.description() ,is("We’ve entered a new era.")),
                () -> assertThat(channel.link() , is("http://www.rawdatapodcast.com")),
                () -> assertThat(channel.pubDate(), is("Thu, 21 Nov 2019 09:00:00 -0000")),
                () -> assertThat(channel.lastBuildDate(), is("Wed, 17 Mar 2021 19:22:02 -0000")),
                () -> assertThat(channel.language(), is("en")),
                () -> assertThat(channel.copyright(), is("All rights reserved")),
                () -> assertThat(channel.generator(), is("PRX Feeder v1.0.0")),
                () -> assertThat(channel.image().url(), is("https://f.prxu.org/190/images/RawData_ForWeb_RGB.png")),
                () -> assertThat(channel.image().title(), is("Raw Data")),
                () -> assertThat(channel.image().link(), is("http://www.rawdatapodcast.com"))
        );
    }
    ...
    void load_RSS_should_contain_episode_data(@RSSURI("simple_podcast.rss") String simplePodcastURI) throws PodcastReaderException {
        ...
        assertAll(
                ...
                () -> assertThat(firstItem.enclosure(),is(notNullValue())),
    ...
    class ItunesPodcastElementTest {
        ...
        void load_RSS_should_contain_itunes_data(@RSSURI("podcast_with_itunes.rss") String podcastWithItunesURI) throws PodcastReaderException {
            ...
            assertAll(
                    ...
                    , () -> assertThat(itunes.category().subCategories(),
                            both(hasSize(1)).and(contains(equalTo("Information Technology"))))
